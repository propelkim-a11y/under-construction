// =========================================================================
// physics.js - 시각 치수 완전 일치본 전체 소스 코드 (1단계 교정 완결본)
// =========================================================================
...
// 통일된 월드 공간 스케일 세팅
const MAX_WORLD_X = 180; // 180m 최대 전진 거리
const MAX_WORLD_Y = 30;  // 30m 최대 높이
const MAX_WORLD_Z = 15;  // (±15m) 좌우 최대 관측 편차 범위
const TARGET_SLANT_R = 145; // 사대 0점부터 과녁 바닥 전면까지의 고정 경사 거리 145m

// 국궁 표준 과녁 물리 제원 및 수직 투영 보정
const TGT_W = 2.0; // 2m 가로
const TGT_H = 2.667; // 2.667m 실제 사선 세로 길이
const TGT_D = 0.5; // 0.5m 두께
const TGT_TILT = 15 * Math.PI / 180; // 뒤로 15도 기울어짐 라디안
const TGT_PROJ_H = TGT_H * Math.cos(TGT_TILT); // 2.58m 정면 측면에서 보이는 수직 투영 높이
